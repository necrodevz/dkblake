...
export default class Home extends Component {
  ...
  render() {
    ...
    return (
      <div>
        { visible ? <FixedMenu location={location} /> : null }
        ...
        <Segment style={{ padding: '8em 0em' }} vertical>
          <Grid container stackable verticalAlign='middle'>
            <Grid.Row>
              <Grid.Column width={8}>
                <Header as='h3' style={{ fontSize: '2em' }}>I Help Companies and Individuals</Header>
                <p style={{ fontSize: '1.33em' }}>
                  I can give your company superpowers to do things that they never thought possible. Let me delight
                  your customers and empower your needs.
                </p>
